...
public class CarJumpMove : MonoBehaviour
{
    ...
    Rigidbody _rb;
    CarState _controller;

    void Start()
    {
        _rb = GetComponentInParent<Rigidbody>();
        _controller = GetComponent<CarState>();
    }
    ...
    {
        if (_controller._states != CarState.CarStates.BodyGroundDead) return;
